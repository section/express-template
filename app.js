...
app.get('/', (req, res) => {
  res.send(
    "<h1>Hello World from Node Express on Section!</h1><p>This app is being served from 4 locations around the world for low latency and high availability: New York, SFO, Amsterdam, Sydney.</p>\
