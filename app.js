...
app.get('/', (req, res) => {
  res.send(
    "<h1>YAY 1 Hello World from Node Express on Section!</h1><p>This app is being served from 4 locations around the world for <b>low latency</b> and <b>high availability</b>: New York, SFO, Amsterdam, Sydney.</p>\
